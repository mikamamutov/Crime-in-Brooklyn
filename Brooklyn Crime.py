...
df_brooklyn_theft = df_brooklyn_theft_filtered[["Crime","Start_date","Current_total"]]
...
#     fig = px.line(filtered_df, x='Start_date', y='Current_total', color='Crime', title='Crime Totals Over Time')
#     return fig
#
